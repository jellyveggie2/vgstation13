...
/obj/machinery/chemheater/RefreshParts()
	...
	for(var/obj/item/weapon/stock_parts/capacitor/C in component_parts)
		T += C.rating-1
	idle_power_usage = initial_idle_power - (T * 10 * initial_idle_power.unit()) //T1: 25w, T2: 15w, T3: 5w
	active_power_usage = initial_active_power - (T * 2000 * initial_active_power.unit()) //T1: 5000w, T2: 3000w, T3: 1000w
...
/obj/machinery/chemcooler/RefreshParts()
	...
	for(var/obj/item/weapon/stock_parts/capacitor/C in component_parts)
		T += C.rating-1
	idle_power_usage = initial_idle_power - (T * 10 * initial_idle_power.unit()) //T1: 25w, T2: 15w, T3: 5w
	active_power_usage = initial_active_power - (T * 2000 * initial_active_power.unit()) //T1: 5000w, T2: 2500w, T3: 1250w
